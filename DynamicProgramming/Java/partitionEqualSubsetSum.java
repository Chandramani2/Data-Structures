/*
    Partition Equal Subset Sum  - Partition into 2 subsets and check both subsets have equal sum
    s1 = s2 = totalSum/2
    if totalSum is odd -> notPossible
 */
private static boolean canPartition(int[] nums, int n) {
   ...
   return isSubsetPresent(nums,n,n-1,target) && isSubsetPresentMemo(nums,n,n-1, target, dp);
...
public static void main(String[] args){
    ...
    System.out.println("CanPartition: " + canPartition(nums,n));
}
